...
public class VillagerRegistry 
{
    ...
    public interface IVillageCreationHandler
    {
         ...
         * @param i
         */
        PieceWeight getVillagePieceWeight(Random random, int i);
         ...
         * @param p5
         */
        Object buildComponent(PieceWeight villagePiece, AGlobalStart startPiece, @SuppressWarnings("rawtypes") List pieces, Random random, int p1,
    ...
    public static void addExtraVillageComponents(@SuppressWarnings("rawtypes") ArrayList components, Random random, int i)
    {
        ...
        List<PieceWeight> parts = components;
    ...
    public static Object getVillageComponent(PieceWeight villagePiece, AGlobalStart startPiece, @SuppressWarnings("rawtypes") List pieces, Random random,
