...
public class StructurePlain extends StructureTools
{
	public static class Inn extends GlobalFeature
	{
		public static final WeightedRandomChestContent[] itemsToGenerateInn = new WeightedRandomChestContent[] {new WeightedRandomChestContent(Items.golden_helmet, 0, 1, 5, 10), new WeightedRandomChestContent(Items.golden_boots, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_ingot, 0, 2, 9, 15), new WeightedRandomChestContent(Items.golden_sword, 0, 1, 5, 12), new WeightedRandomChestContent(Items.golden_chestplate, 0, 1, 5, 10), new WeightedRandomChestContent(Items.golden_apple, 0, 5, 10, 20), new WeightedRandomChestContent(Items.golden_leggings, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_nugget, 0, 10, 10, 20)};   
        ...
        public Inn(Random random, int coordX, int coordZ)
        {
            ...
            isTorch[0] = random.nextBoolean();
            isTorch[1] = random.nextBoolean();
            isTorch[2] = isTorch[0] && isTorch[1] ? false : random.nextBoolean();
        }
        
        protected void func_143012_a(NBTTagCompound p_143012_1_)
        {
            super.func_143012_a(p_143012_1_);
            p_143012_1_.setBoolean("T0", isTorch[0]);
            p_143012_1_.setBoolean("T1", isTorch[1]);
            p_143012_1_.setBoolean("T2", isTorch[2]);
        }
		...
		protected boolean build(World world, Random random, StructureBoundingBox structureBoundingBox)
		{
            ...
            for (int x = 0; x < 21; ++x)
            {
                for (int z = -1; z < 11; ++z)
                {
                    ...
                    this.placeBlockAtCurrentPosition(world, Blocks.grass, 0, x, 0, z, structureBoundingBox);
                }
            }
            ...
            this.fillWithMetadataBlocks(world, structureBoundingBox, 5, 4, 3, 7, 4, 3, Blocks.log, DirectionTools.log[coordBaseMode][0], Blocks.log, DirectionTools.log[coordBaseMode][0], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 5, 4, 9, 7, 4, 9, Blocks.log, DirectionTools.log[coordBaseMode][0], Blocks.log, DirectionTools.log[coordBaseMode][0], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 3, 4, 5, 3, 4, 7, Blocks.log, DirectionTools.log[coordBaseMode][1], Blocks.log, DirectionTools.log[coordBaseMode][1], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 9, 4, 5, 9, 4, 7, Blocks.log, DirectionTools.log[coordBaseMode][1], Blocks.log, DirectionTools.log[coordBaseMode][1], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 13, 4, 5, 13, 4, 7, Blocks.log, DirectionTools.log[coordBaseMode][1], Blocks.log, DirectionTools.log[coordBaseMode][1], false);
            ...
            this.fillWithMetadataBlocks(world, structureBoundingBox, 2, 5, 4, 2, 5, 8, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 3, 6, 3, 3, 6, 9, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 4, 7, 3, 4, 7, 9, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], false);
            this.fillWithBlocks(world, structureBoundingBox, 5, 8, 3, 5, 8, 9, Blocks.wooden_slab, Blocks.wooden_slab, false);
            this.fillWithBlocks(world, structureBoundingBox, 6, 8, 3, 6, 8, 9, Blocks.planks, Blocks.planks, false);
            this.fillWithBlocks(world, structureBoundingBox, 7, 8, 3, 7, 8, 9, Blocks.wooden_slab, Blocks.wooden_slab, false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 8, 7, 3, 8, 7, 9, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 9, 6, 3, 9, 6, 9, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 10, 5, 4, 10, 5, 8, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], false);

            this.fillWithMetadataBlocks(world, structureBoundingBox, 9, 3, 3, 13, 3, 3, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][3], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][3], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 10, 4, 4, 13, 4, 4, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][3], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][3], false);
            this.fillWithBlocks(world, structureBoundingBox, 11, 5, 5, 13, 5, 5, Blocks.wooden_slab, Blocks.wooden_slab, false);
            this.fillWithBlocks(world, structureBoundingBox, 10, 5, 6, 13, 5, 6, Blocks.planks, Blocks.planks, false);
            this.fillWithBlocks(world, structureBoundingBox, 11, 5, 7, 13, 5, 7, Blocks.wooden_slab, Blocks.wooden_slab, false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 10, 4, 8, 13, 4, 8, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], false);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 9, 3, 9, 13, 3, 9, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], false);
            ...
            this.fillWithMetadataBlocks(world, structureBoundingBox, 4, 4, 4, 8, 4, 8, Blocks.wooden_slab, 8, Blocks.wooden_slab, 8, false);

            this.placeBlockAtCurrentPosition(world, Blocks.log, DirectionTools.log[coordBaseMode][0], 6, 0, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.log, DirectionTools.log[coordBaseMode][0], 11, 0, 8, structureBoundingBox);
            this.fillWithMetadataBlocks(world, structureBoundingBox, 5, 0, 5, 5, 0, 7, Blocks.log, DirectionTools.log[coordBaseMode][1], Blocks.log, DirectionTools.log[coordBaseMode][1], false);
            
            this.placeBlockAtCurrentPosition(world, Blocks.log, 0, 5, 1, 5, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wooden_slab, 8, 5, 1, 6, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wooden_slab, 8, 5, 1, 7, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.spruce_stairs, DirectionTools.stair[coordBaseMode][1], 6, 1, 8, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.spruce_stairs, DirectionTools.stair[coordBaseMode][0], 8, 1, 8, structureBoundingBox);

            this.placeBlockAtCurrentPosition(world, Blocks.spruce_stairs, DirectionTools.stair[coordBaseMode][2], 8, 1, 4, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.spruce_stairs, DirectionTools.stair[coordBaseMode][0], 9, 1, 5, structureBoundingBox);

            this.placeBlockAtCurrentPosition(world, Blocks.spruce_stairs, DirectionTools.stair[coordBaseMode][3], 12, 1, 7, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.spruce_stairs, DirectionTools.stair[coordBaseMode][2], 12, 1, 5, structureBoundingBox);
            
            this.placeBlockAtCurrentPosition(world, Blocks.double_plant, 3, 9, 1, 9, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.double_plant, 11, 9, 2, 9, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.double_plant, 4, 9, 1, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.double_plant, 12, 9, 2, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.red_flower, 8, 10, 1, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.red_flower, 0, 11, 1, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.double_plant, 3, 12, 1, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.double_plant, 11, 12, 2, 3, structureBoundingBox);
            ...
            int meta = this.getMetadataWithOffset(Blocks.ladder, 3);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.wooden_slab, 8, 8, -2, 5, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wooden_slab, 8, 9, -2, 5, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.log, DirectionTools.log[coordBaseMode][1], 6, -1, 8, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.log, DirectionTools.log[coordBaseMode][1], 8, -1, 8, structureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.log, DirectionTools.log[coordBaseMode][1], 10, -1, 8, structureBoundingBox);
            ...
            if (isTorch[0]) {
            	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][2], 6, -1, 9, structureBoundingBox);
            } else {
            	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 6, -1, 9, structureBoundingBox);
            }
            if (isTorch[1]) {
            	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][2], 8, -1, 9, structureBoundingBox);
            } else {
                this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 8, -1, 9, structureBoundingBox);
            }
            if (isTorch[2]) {
            	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][2], 10, -1, 9, structureBoundingBox);
            } else {
                this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 10, -1, 9, structureBoundingBox);
            }
            
            this.fillWithBlocks(world, structureBoundingBox, 4, -1, 10, 10, -1, 10, Blocks.redstone_wire, Blocks.redstone_wire, false);
            ...
            this.placeBlockAtCurrentPosition(world, Blocks.sticky_piston, this.getMetadataWithOffset(Blocks.sticky_piston, 3), 3, -1, 10, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sticky_piston, this.getMetadataWithOffset(Blocks.sticky_piston, 3), 3, -2, 10, structureBoundingBox);
            ...
            this.fillWithBlocks(world, structureBoundingBox, 4, -8, 4, 4, -8, 6, Blocks.stone_slab, Blocks.stone_slab, false);
            this.fillWithAir(world, structureBoundingBox, 1, -7, 4, 4, -5, 6);
            this.fillWithBlocks(world, structureBoundingBox, 5, -9, 3, 5, -9, 7, Blocks.double_stone_slab, Blocks.double_stone_slab, false);
            this.fillWithAir(world, structureBoundingBox, 5, -8, 3, 5, -5, 7);
            this.fillWithBlocks(world, structureBoundingBox, 6, -9, 2, 6, -9, 8, Blocks.stone_slab, Blocks.stone_slab, false);
            ...
            this.fillWithBlocks(world, structureBoundingBox, 15, -9, 4, 17, -9, 6, Blocks.stone_slab, Blocks.stone_slab, false);
            this.fillWithBlocks(world, structureBoundingBox, 15, -9, 5, 16, -9, 5, Blocks.double_stone_slab, Blocks.double_stone_slab, false);
            this.fillWithBlocks(world, structureBoundingBox, 15, -8, 5, 16, -8, 5, Blocks.stone_slab, Blocks.stone_slab, false);
            ...
            this.generateStructureChestContents(world, structureBoundingBox, random, 14, -9, 5, ChestGenTools.getItems(ChestGenTools.INN_CHEST, random), ChestGenTools.getCount(ChestGenTools.INN_CHEST, random));
		...
		protected EntityLiving getNewEntity(World world, int choice)
		{
			...
			case 1 :
				return new EntitySettled(world, EnumVillager.SETTLED_INNKEEPER);
			case 2 :
				return new EntitySettled(world, world.rand.nextBoolean() ? EnumVillager.SETTLED_VILLAGER : EnumVillager.SETTLED_FARMER);
			case 3 :
