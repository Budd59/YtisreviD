...
{
	private boolean[] isChestPiece = new boolean[4];
	
    public EgyptianPyramid() {}
	
    public EgyptianPyramid(Random random, int coordX, int coordZ)
    {
        super(random, coordX, coordZ, 21, 15 , 21);          
        isChestPiece[0] = random.nextBoolean();
        isChestPiece[1] = random.nextBoolean();
        isChestPiece[2] = random.nextBoolean();
        isChestPiece[3] = random.nextBoolean();
    }
    
    protected void func_143012_a(NBTTagCompound p_143012_1_)
    {
        super.func_143012_a(p_143012_1_);
        p_143012_1_.setBoolean("M0", isChestPiece[0]);
        p_143012_1_.setBoolean("M1", isChestPiece[1]);
        p_143012_1_.setBoolean("M2", isChestPiece[2]);
        p_143012_1_.setBoolean("M3", isChestPiece[3]);
    }
	...
	{       	
        ...
        for (i = 0; i < this.scatteredFeatureSizeX; ++i)
        {
            ...
            {
                byte b0 = -5;
                this.func_151554_b(world, Blocks.sandstone, 0, i, b0, j, structureBoundingBox);
            }
        }
        ...
        this.placeBlockAtCurrentPosition(world, Blocks.sandstone_stairs, k, 4, 10, 2, structureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(world, Blocks.sandstone_stairs, k, this.scatteredFeatureSizeX - 1, 10, 2, structureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(world, Blocks.stone_slab, 1, 1, 2, 2, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.stone_slab, 1, this.scatteredFeatureSizeX - 2, 2, 2, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.sandstone_stairs, k, 2, 1, 2, structureBoundingBox);
        ...
        for (l = 5; l <= 17; l += 2)
        {
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, 4, 1, l, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, 4, 2, l, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, this.scatteredFeatureSizeX - 5, 1, l, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, this.scatteredFeatureSizeX - 5, 2, l, structureBoundingBox);
        }

        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 10, 0, 7, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 10, 0, 8, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 9, 0, 9, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 11, 0, 9, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 8, 0, 10, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 12, 0, 10, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 7, 0, 10, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 13, 0, 10, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 9, 0, 11, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 11, 0, 11, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 10, 0, 12, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 10, 0, 13, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b2, 10, 0, 10, structureBoundingBox);

        for (l = 0; l <= this.scatteredFeatureSizeX - 1; l += this.scatteredFeatureSizeX - 1)
        {
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 2, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 2, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 2, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 3, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 3, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 3, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 4, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, l, 4, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 4, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 5, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 5, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 5, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 6, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, l, 6, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 6, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 7, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 7, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 7, 3, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 8, 1, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 8, 2, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 8, 3, structureBoundingBox);
        }

        for (l = 2; l <= this.scatteredFeatureSizeX - 3; l += this.scatteredFeatureSizeX - 3 - 2)
        {
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l - 1, 2, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 2, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l + 1, 2, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l - 1, 3, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 3, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l + 1, 3, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l - 1, 4, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, l, 4, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l + 1, 4, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l - 1, 5, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 5, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l + 1, 5, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l - 1, 6, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, l, 6, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l + 1, 6, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l - 1, 7, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l, 7, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, l + 1, 7, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l - 1, 8, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l, 8, 0, structureBoundingBox);
            this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 2, l + 1, 8, 0, structureBoundingBox);
        }
        ...
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 9, 5, 0, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 1, 10, 5, 0, structureBoundingBox);
        this.placeBlockAtCurrentPosition(world, Blocks.wool, b1, 11, 5, 0, structureBoundingBox);
    	...
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 8, -13, 12, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 0, 10, -13, 12, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][1], 11, -13, 12, structureBoundingBox);        	
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 12, -13, 12, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 12, -13, 11, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 12, -13, 10, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 12, -13, 9, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 12, -13, 8, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 11, -13, 8, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 10, -13, 8, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 9, -13, 8, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 8, -13, 8, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 8, -13, 9, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.sandstone, 0, 8, -13, 10, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][2], 8, -13, 11, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 10, -13, 11, structureBoundingBox);
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 10, -13, 10, structureBoundingBox);
    	
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 13, -13, 12, structureBoundingBox);
    	...
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 13, -12, 13, structureBoundingBox);
    	...
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][3], 13, -10, 13, structureBoundingBox);
    	
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 7, -13, 8, structureBoundingBox);
    	...
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 7, -12, 7, structureBoundingBox);
    	...
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_torch, DirectionTools.torch[coordBaseMode][2], 7, -10, 7, structureBoundingBox);
    	
    	this.placeBlockAtCurrentPosition(world, Blocks.redstone_wire, 0, 9, -13, 12, structureBoundingBox);

    	for (l = 0; l < 4; ++l)
        {	
            int x = Direction.offsetX[l] * 3 + Direction.offsetZ[l];
            int z = Direction.offsetZ[l] * 3 + Direction.offsetX[l];
            ...
            x = Direction.offsetX[l] * 3 + Direction.offsetZ[l] * 2;
            z = Direction.offsetZ[l] * 3 + Direction.offsetX[l] * 2;
            int direction = this.getMetadataWithOffset(Blocks.sticky_piston, Direction.directionToFacing[(l+1)%4]);

        	this.placeBlockAtCurrentPosition(world, Blocks.sticky_piston, direction, 10 + x, -10, 10 + z, structureBoundingBox);
        	this.placeBlockAtCurrentPosition(world, Blocks.sticky_piston, direction, 10 + x, -11, 10 + z, structureBoundingBox);
        
        	x = Direction.offsetX[l] * 2;
        	z = Direction.offsetZ[l] * 2;

        	this.placeBlockAtCurrentPosition(world, Blocks.air, 0, 10 + x, -11, 10 + z, structureBoundingBox);

        	x = Direction.offsetX[l] - Direction.offsetZ[l];
        	z = Direction.offsetZ[l] - Direction.offsetX[l];
        	if (Direction.offsetZ[l]==0) {
            ...
            if (this.isChestPiece[l])
            {
                ...
                this.generateStructureChestContents(world, structureBoundingBox, random, 10 + Direction.offsetX[l]*6, -11, 10 + Direction.offsetZ[l]*6, ChestGenHooks.getItems(PYRAMID_DESERT_CHEST, random), ChestGenHooks.getCount(PYRAMID_DESERT_CHEST, random));
            	this.spawnEntity(world, structureBoundingBox, 10 + Direction.offsetX[l]*5, -11, 10 + Direction.offsetZ[l]*5, 0);
            } else {
            	if (Direction.offsetZ[l]==0)
            	{	
                	if (x<0)
            	...
            	this.spawnEntity(world, structureBoundingBox, 10 + Direction.offsetX[l]*4, -11, 10 + Direction.offsetZ[l]*4, 0);
            }
        }
