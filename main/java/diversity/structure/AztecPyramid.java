...
public class AztecPyramid  extends GlobalFeature
{
    ...
    private static AztecPyramid.Stones junglePyramidsRandomScatteredStones = new AztecPyramid.Stones(null);

    public AztecPyramid() {}
    
    public AztecPyramid(Random random, int coordX, int coordZ)
    {
