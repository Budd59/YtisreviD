...
public class EntityTzitzimime extends EntityMob
{
	public EntityTzitzimime(World world) {
		super(world);
    ...
    {
        this.dropItem(Items.rotten_flesh, 1 + this.rand.nextInt(1));
        this.dropItem(Items.bone, 3 + rand.nextInt(3));
    }
    ...
    protected void dropRareDrop(int p_70600_1_)
    {
        switch (this.rand.nextInt(4))
        {
            case 0:
                ...
                break;
            case 1:
                this.dropItem(Items.gold_ingot, this.rand.nextInt(3));
                break;
            case 2:
                this.dropItem(Items.golden_sword, 1);
                break;
        }
        this.dropItem(Items.gold_nugget, 4 + this.rand.nextInt(4));
    }
    ...
    {
    	worldObj.spawnParticle("reddust", posX, posY+1.666, posZ, 0.0D /*red*/,  1.0D/*green*/, 0.0D /*blue*/);
