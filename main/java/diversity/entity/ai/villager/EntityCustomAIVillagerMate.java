...
public class EntityCustomAIVillagerMate extends EntityAIBase
{
    private AGlobalEntityVillager villagerObj;
    private AGlobalEntityVillager mate;
    private World worldObj;
    private int matingTimeout;
    Village villageObj;
    private static final String __OBFID = "CL_00001594";

    public EntityCustomAIVillagerMate(AGlobalEntityVillager p_i1634_1_)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    this.mate = (AGlobalEntityVillager)entity;
    ...
    {
        AGlobalEntityVillager entityvillager = this.villagerObj.createChild(this.mate);
