...
public class EntityCustomAIPlay extends EntityAIBase
{
    ...
    public EntityCustomAIPlay(AGlobalEntityVillager p_i1646_1_, double p_i1646_2_)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                AGlobalEntityVillager entityvillager = (AGlobalEntityVillager)iterator.next();
