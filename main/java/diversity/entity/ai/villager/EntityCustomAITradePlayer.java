...
public class EntityCustomAITradePlayer extends EntityAIBase
{
    private AGlobalEntityVillager villager;
    private static final String __OBFID = "CL_00001617";

    public EntityCustomAITradePlayer(AGlobalEntityVillager p_i1658_1_)
    {
