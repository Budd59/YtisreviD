...
import diversity.utils.DiversityDamageSource;
...
public class EntityDart extends Entity implements IProjectile
{
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = DiversityDamageSource.causeDartDamage(this, this);
                    }
                    else
                    {
                        damagesource = DiversityDamageSource.causeDartDamage(this, this.shootingEntity);
                    }
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            entitylivingbase.addPotionEffect(new PotionEffect(Potion.poison.id, 150+rand.nextInt(100)));
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(EnumItem.dart.item, 1)))
            {
                flag = false;
            }
